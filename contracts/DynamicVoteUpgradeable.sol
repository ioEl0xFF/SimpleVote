...
/**
 * @title DynamicVoteUpgradeable
 * @notice 初期化可能な多人数投票コントラクトです。アップグレード後も状態を保持できます。
 */
contract DynamicVoteUpgradeable is Initializable, OwnableUpgradeable {
    /// 議題
    string public topic;
    /// 選択肢 ID => 選択肢名
    ...
    /**
     * @notice コントラクトの初期化処理。デプロイ後に一度だけ呼び出されます。
     * @param _topic 議題
     */
    function initialize(string memory _topic) public initializer {
